...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zeeshan.todolite.R.layout.activity_login);
        ...
        LoginButton facebookLoginButton = (LoginButton) findViewById(com.zeeshan.todolite.R.id.facebook_login_button);
        ...
        Button guestLoginButton = (Button) findViewById(com.zeeshan.todolite.R.id.guest_login_button);
